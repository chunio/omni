...
function funcProtectedCloudSeletor() {
  ...
  local variPaddlewaverCloudSlice=(
    ...
    # ----------
    "08 DSP BID 04 PADDLEWAVER SINGAPORE 129.226.216.15 22 --"
    "09 DSP BID 05 PADDLEWAVER SINGAPORE 43.134.237.75 22 --"
    # ----------
  ...
  local variYoneCloudSlice=(
    ...
    # ----------
    "05 ADX BID 01 YONE SINGAPORE 43.134.233.205 22 --"
    "06 ADX BID 02 YONE SINGAPORE 43.156.95.137 22 --"
    "07 ADX BID 03 YONE SINGAPORE 43.133.61.166 22 --"
    "08 ADX BID 04 YONE SINGAPORE 43.156.53.25 22 --"
    # "09 ADX BID 05 YONE SINGAPORE 43.163.123.80 22 --"
    # "10 ADX BID 06 YONE SINGAPORE 43.159.32.73 22 --"
    # "11 ADX BID 07 YONE SINGAPORE 43.134.59.163 22 --"
    # ----------
