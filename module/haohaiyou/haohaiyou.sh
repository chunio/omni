...
function funcProtectedCloudSelector() {
  ...
  local variPaddlewaverCloudSlice=(
    ...
    "11 ADX BID 01 PADDLEWAVER USEAST 43.166.250.183 22 --"
    "12 ADX BID 02 PADDLEWAVER USEAST 170.106.165.51 22 --"
    "13 ADX BID 03 PADDLEWAVER USEAST 170.106.9.32 22 --"
    "14 ADX BID 04 PADDLEWAVER USEAST 43.166.253.225 22 --"
    # ==================================================
