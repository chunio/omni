...
function funcProtectedCloudSeletor() {
  ...
  local variPaddlewaverCloudSlice=(
    ...
    "24 DSP BID 01 PADDLEWAVER USEAST 43.130.90.22 22 --"
    "25 DSP BID 02 PADDLEWAVER USEAST 43.130.108.36 22 --" 
    "26 DSP BID 03 PADDLEWAVER USEAST 43.166.134.30 22 --" 
    "27 DSP BID 04 PADDLEWAVER USEAST 43.166.233.154 22 --" 
    # ==================================================
  )
