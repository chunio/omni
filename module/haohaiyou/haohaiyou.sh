...
function funcProtectedCloudSeletor() {
  ...
  local variPaddlewaverCloudSlice=(
    ...
    # "05 DSP BID 01 PADDLEWAVER SINGAPORE 43.134.241.241 22 4C4G"
    # "06 DSP BID 02 PADDLEWAVER SINGAPORE 119.28.114.114 22 4C4G"
    # "07 DSP BID 03 PADDLEWAVER SINGAPORE 43.156.43.47 22 4C4G"
    # "08 DSP BID 04 PADDLEWAVER SINGAPORE 129.226.216.15 22 4C4G"
    # "09 DSP BID 05 PADDLEWAVER SINGAPORE 43.134.237.75 22 4C4G"
    # ----------
    ...
    # ----------
    "12 DSP BID 01 PADDLEWAVER USEAST 43.130.90.22 22 --"
    "13 DSP BID 02 PADDLEWAVER USEAST 43.130.108.36 22 --" 
    "14 DSP BID 03 PADDLEWAVER USEAST 43.166.134.30 22 --" 
    "15 DSP BID 04 PADDLEWAVER USEAST 43.166.233.154 22 --" 
    # ==================================================
  )
